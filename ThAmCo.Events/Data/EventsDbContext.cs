    ...
    public class EventsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Staffing>()
                   .HasKey(k => new { k.StaffID, k.EventID });
            ...
            if (HostEnv != null && HostEnv.IsDevelopment())
            {
                ...
                builder.Entity<Staff>().HasData(
                    new Staff { StaffID = 1, StaffSurname = "Souch", StaffFirstName = "Ben", StaffEmail = "BSouch@email.com", FirstAider = true },
                    new Staff { StaffID = 2, StaffSurname = "Jardine", StaffFirstName = "Jacob", StaffEmail = "JJardine@email.com", FirstAider = false }
                );
